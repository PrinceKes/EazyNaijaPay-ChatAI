...
// MongoDB connection
const client = new MongoClient("mongodb+srv://EazyNaijaPay:Adeboye2003@eazynaijapay.asnqh.mongodb.net/EazyNaijaPay-App?retryWrites=true&w=majority", {
...
// Middleware
app.use(cors({ origin: 'https://eazynaijapay-app.onrender.com' })); // Enable CORS for your frontend
...
// Generate a virtual account (Paystack integration)
